package kr.or.ddit.clap.view.genremusic.song;
...
public class SongController implements Initializable{
	...
	@FXML JFXButton btn_ballad;
	@FXML JFXButton btn_dance;
	...
	private ObservableList<Map> balladRank;
	private ObservableList<Map> danceRank;
	...
	// 발라드장르
	@FXML public void balladChart() {
		try {
			balladRank = FXCollections.observableArrayList(ims.genreMusicSelete("1"));
			btn_ballad.setStyle("-fx-background-color:#9c0000;-fx-text-fill:#FFFFFF;");
			btn_dance.setStyle("-fx-background-color:#FFFFFF;");
	...
	// 댄스장르
	@FXML public void danceChart() {
		try {
			danceRank = FXCollections.observableArrayList(ims.genreMusicSelete("2"));
			btn_ballad.setStyle("-fx-background-color:#FFFFFF;");
			btn_dance.setStyle("-fx-background-color:#9c0000;-fx-text-fill:#FFFFFF;");
			btn_rnb.setStyle("-fx-background-color:#FFFFFF;");
			btn_hiphop.setStyle("-fx-background-color:#FFFFFF;");
	...
	@FXML public void rnbChart() {
		try {
			rnbRank = FXCollections.observableArrayList(ims.genreMusicSelete("3"));
			btn_ballad.setStyle("-fx-background-color:#FFFFFF;");
			btn_dance.setStyle("-fx-background-color:#FFFFFF;");
	...
	@FXML public void hiphopChart() {
		try {
			hiphopRank = FXCollections.observableArrayList(ims.genreMusicSelete("4"));
			btn_ballad.setStyle("-fx-background-color:#FFFFFF;");
			btn_dance.setStyle("-fx-background-color:#FFFFFF;");
			btn_rnb.setStyle("-fx-background-color:#FFFFFF;");
