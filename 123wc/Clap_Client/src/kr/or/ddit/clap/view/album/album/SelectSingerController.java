...
public class SelectSingerController implements Initializable {
	...
	private InsertAlbumController iAC;
	
	public void setcontroller(InsertAlbumController iAC){
		this.iAC = iAC;
	}
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		tbl_singer.setOnMouseClicked(e ->{
			if (e.getClickCount()  > 1) {
				...
				InsertAlbumController.singNo = singName;
